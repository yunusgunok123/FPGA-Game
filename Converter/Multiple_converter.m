...
% registername = "rocket"
% new_foldername = "Ships"
% Multiple_converter(foldername, colorcodes, registername, new_foldername)

function Multiple_converter(foldername, colorcodes, registername, new_foldername)
...
% foldername is a string corresponding to the name of the folder in which there are the PNG files which will be processed

% colorcodes is an Mx3 array where M can be any integer, and that represent the color palette
% Each element should be between 0 to 255 integer
...
% If you only want reconstructed png files the what you write for registername does not important
